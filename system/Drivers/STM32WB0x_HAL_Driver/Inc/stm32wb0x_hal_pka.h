...
#ifndef STM32WB0x_HAL_PKA_H
#define STM32WB0x_HAL_PKA_H
...
#endif /* STM32WB05 || STM32WB09 */
#if defined (STM32WB09)
#define PKA_MODE_ECDSA_VERIFICATION               (0x00000025U)
...
#define PKA_FLAG_ADDRERR                          PKA_ISR_ADD_ERR
#define PKA_FLAG_RAMERR                           PKA_ISR_RAM_ERR
#endif /* STM32WB06 || STM32WB07 */
/**
  * @}
  */
...
/** @brief  Check whether the specified PKA interrupt source is enabled or not.
  ...
  */
#if defined (STM32WB06) || defined(STM32WB07)
#define __HAL_PKA_GET_IT_SOURCE(__HANDLE__, __INTERRUPT__)      ((((__HANDLE__)->Instance->IEN\
...
/** @brief  Check whether the specified PKA flag is set or not.
  ...
  */
#if defined (STM32WB06) || defined(STM32WB07)
#define __HAL_PKA_GET_FLAG(__HANDLE__, __FLAG__)                (((((__HANDLE__)->Instance->ISR)\
