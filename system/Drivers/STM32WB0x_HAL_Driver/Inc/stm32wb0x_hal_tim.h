...
#ifndef STM32WB0x_HAL_TIM_H
#define STM32WB0x_HAL_TIM_H
...
#endif /* USE_HAL_TIM_REGISTER_CALLBACKS */
{
...
#if defined(TIM_DMA_SUPPORT)
  DMA_HandleTypeDef                  *hdma[5];          /*!< DMA Handlers array
  ...
  __IO HAL_TIM_ChannelStateTypeDef   ChannelNState[3];  /*!< TIM complementary channel operation state         */
#else
...
#if defined(TIM_DMA_SUPPORT)
#define IS_TIM_DMA_SOURCE(__SOURCE__) ((((__SOURCE__) & 0xFFFFE0FFU) == 0x00000000U) && ((__SOURCE__) != 0x00000000U))
#endif /* TIM_DMA_SUPPORT */
...
#include "stm32wb0x_hal_tim_ex.h"
