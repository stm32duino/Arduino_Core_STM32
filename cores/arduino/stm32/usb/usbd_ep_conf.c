...
const ep_desc_t ep_def[] = {
  ...
  {0, 0x080},  // receive buffer    // 40 or 80 works but not 100     
  {0, 0x040},  // EP0 FIFO size
  {1, 0x040},  // EP1 FIFO size
  {2, 0x040},  // EP2 FIFO size     // 40 works but 100 doesn't
  {3, 0x040}   // EP3 FIFO size
  
//  {0, 0x80}, // 40 or 80 works but not 100
//  {0, 0x40}, 
//  {1, 0x40},
//  {2, 0x40}, 
//  {3, 0x40}   
//  
#elif defined(USE_USB_HS) /* USE_USB_FS */
...
#elif defined(USB_OTG_FS)  /* USE_USB_FS */
