...
void CDC_init(void)
{
  ...
  if (!CDC_initialized) {
    ...
    /* Add Supported Class */
    USBD_RegisterClass(&hUSBD_Device_CDC, &USBD_MSC_CDC_ClassDriver);
    /* Add CDC Interface Class */
    USBD_CDC_RegisterInterface(&hUSBD_Device_CDC, &USBD_CDC_fops);
    /* Start SD card interface */
    USBD_MSC_RegisterStorage(&hUSBD_Device_CDC, &SdMscDriver);
