/**
  ...
  *           structures dealing with the DMA during the transaction process
...
__ALIGN_BEGIN static uint8_t
    USBD_HID_CfgFSDesc[USB_COMPOSITE_HID_CONFIG_DESC_SIZ] __ALIGN_END = {
...
__ALIGN_BEGIN static uint8_t
    USBD_HID_CfgHSDesc[USB_COMPOSITE_HID_CONFIG_DESC_SIZ] __ALIGN_END = {
  0x09, /* bLength: Configuration Descriptor size */
  USB_DESC_TYPE_CONFIGURATION, /* bDescriptorType: Configuration */
  LOBYTE(USB_COMPOSITE_HID_CONFIG_DESC_SIZ), /* wTotalLength: Bytes
                                                returned */
...
__ALIGN_BEGIN static uint8_t
    USBD_HID_OtherSpeedCfgDesc[USB_COMPOSITE_HID_CONFIG_DESC_SIZ] __ALIGN_END = {
  0x09, /* bLength: Configuration Descriptor size */
  USB_DESC_TYPE_CONFIGURATION, /* bDescriptorType: Configuration */
  LOBYTE(USB_COMPOSITE_HID_CONFIG_DESC_SIZ), /* wTotalLength: Bytes
                                                returned */
...
__ALIGN_BEGIN static uint8_t
    USBD_MOUSE_HID_Desc[USB_HID_DESC_SIZ] __ALIGN_END = {
  0x09,                /* bLength: HID Descriptor size */
  HID_DESCRIPTOR_TYPE, /* bDescriptorType: HID */
  0x11,                /* bcdHID: HID Class Spec release number */
  0x01,
