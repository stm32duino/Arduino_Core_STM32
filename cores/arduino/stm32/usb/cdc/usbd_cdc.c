/**
  ...
  *           February 9, 2007" This driver implements the following aspects of
  *           the specification:
  ...
  *            specification (but it is possible to manage these features with
  *            some modifications on this driver):
